-- TravelCarry AI Seed Data
-- Targets: users, wallets, reward_badges, trips, parcels, carbon_savings, etc.

-- Clear existing seed data if any (optional, order matters due to foreign keys)
...
('00000000-0000-0000-0000-000000000001', 5450.00, 'INR'),
('00000000-0000-0000-0000-000000000002', 2100.00, 'INR'),
('00000000-0000-0000-0000-000000000003', 450.00, 'INR'),
('10000000-0000-0000-0000-000000000001', 12500.00, 'INR'),
('10000000-0000-0000-0000-000000000002', 1500.00, 'INR');

-- 3. Reward Badges
INSERT INTO reward_badges (id, badge_name, badge_description, icon_url, criteria) VALUES
('b0000000-0000-0000-0000-000000000001', 'Early Bird', 'First delivery completed within estimated delivery window', '/badges/early_bird.svg', 'completed_deliveries >= 1'),
('b0000000-0000-0000-0000-000000000002', 'Fast Delivery', 'Avg delivery duration 20% lower than route average', '/badges/fast_delivery.svg', 'avg_delivery_time_diff < 0'),
('b0000000-0000-0000-0000-000000000003', 'Top Traveler', 'Achieve 4.8+ rating and 10+ completed deliveries', '/badges/top_traveler.svg', 'rating >= 4.8 AND completed_deliveries >= 10'),
('b0000000-0000-0000-0000-000000000004', 'AI Champion', 'Successfully matched and completed 5 AI recommended trips', '/badges/ai_champion.svg', 'ai_match_completed >= 5'),
('b0000000-0000-0000-0000-000000000005', 'Trusted Elite', 'Maintain a trust score of 95+ for 3 consecutive months', '/badges/trusted_elite.svg', 'trust_score >= 95');

-- User Badges assignment
INSERT INTO user_badges (user_id, badge_id) VALUES
('00000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000003'),
('00000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000005'),
('00000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000005');

-- 4. Carbon Savings for Users
INSERT INTO carbon_savings (user_id, co2_saved_kg, fuel_saved_liters, total_trips_shared) VALUES
('00000000-0000-0000-0000-000000000001', 142.50, 58.20, 24),
('00000000-0000-0000-0000-000000000002', 62.10, 25.40, 10),
('00000000-0000-0000-0000-000000000003', 15.40, 6.30, 3);
